...
<body>
    ...
    <div class="all-content-wrapper">
      ...
      echo "
      <img src='http://localhost:8080//ip/zhatpat/upload/0_".$row['picture']."' alt='admin' height='30px'style='width:50%'>
      <br>
			<p class='title'>Product name : ".$row['name']."</p>
			
			<p class='title'>Category : ".$row['category']."</p>
