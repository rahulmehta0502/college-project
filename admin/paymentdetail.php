                                ...
                                <div class='row'>
                                    ...
                                    <div class='col-lg-6 col-md-6 col-sm-6 col-xs-6'>
                                        <ul class='breadcome-menu'>
                                            ...
                                            <li><span class='bread-blod'>Payment / Payment Detail</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class='row'>
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class='product-status-wrap'>
                            ...
                            echo "
                                <tr>
                                    <td> <a href='http://localhost:8080/ip/zhatpat/admin/userprofile.php?id=".$row['sellerid']."'>".$row['sellerid']." </a> </td>
									<td> <a href='http://localhost:8080/ip/zhatpat/admin/userprofile.php?id=".$row['buyerid']."'>".$row['buyerid']."</td> 
									<td> <a href='http://localhost:8080/ip/zhatpat/admin/productinfo.php?pid=".$row['p_id']."'>".$row['p_id']."</td>
									<td>".$row['total']."</td>
									<td>Done/In Progress</td>
									<td>Done/In Progress</td>
                                    <td>
                                    <button class='pd-setting' name=payment value=><a href='http://localhost:8080/ip/zhatpat/admin/payment.php?pid=".$row['p_id']."&bidprice=".$row['total']."'> Payment  </button></a>
                                    </td>
