...
<body>
					...
					<ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="blockusers" href="blockusers.php"><i class="fa fa-frown-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Block Users</span></a></li>
                            </ul>
                        </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">product / Product List</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
	...
	while($row=mysqli_fetch_array($result)) {
        ...
        echo "<td> <a href='http://localhost:8080/ip/zhatpat/admin/userprofile.php?id=".$row['sellid']."'>" . $row["sellid"] . "</td>";
