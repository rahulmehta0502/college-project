					...
					<ul class="metismenu" id="menu1">
						...
						<li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Product Edit" href="product-del.php"><i class="fa fa-circle sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Delivered Products</span></a></li>
                                <li><a title="Product Detail" href="product-req.php"><i class="fa fa-circle sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Product Request</span></a></li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#adminaccount.php">Home <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="product-del.php">Product Detail</a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#adminaccount.php">Home</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">User / Blockusers</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            while($row=mysqli_fetch_array($result)) {
                                ...
                                $image = $row['profile'];
                                $image_src = "http://localhost:8080/ip/zhatpat/upload/". $image;
                                ...
                                echo "<td><button class='pd-setting' name='unblock' value=".$row['id'].">Unblock  </button></td>";
                        ...
                        if(array_key_exists('unblock',$_POST))	{
                            $a=$_POST['unblock'];
                            $sql="select * from blockusers where id='$a'" ;
                            ...
                            $profile=$row['profile'];
                            $sql1="insert into `user`(`id`, `name`, `email`, `phoneno`, `address`, `password`,profile) values ('$id','$name','$email','$phoneno','$address','$password','$profile')" ;
                            if(mysqli_query($conn,$sql1)) {
                                $sql="delete from `blockusers` WHERE id='$a'" ;
