                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Product / Product Request</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            while($row=mysqli_fetch_array($result)) {
                                ...
                                echo "<td><button class='pd-setting' name='approve' value=".$row['pid']."> Approve  </button></td>";
                            
                                echo "<td><button class='pd-setting' name='reject' value=".$row['pid']."> Reject  </button></td>";
                        ...
                        if(array_key_exists('approve',$_POST))	{
                            $a=$_POST['approve'];
                            $sql="update product SET status='1' WHERE pid='$a'";
