                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">User / Seller</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            while($row=mysqli_fetch_array($result)) {
                                ...
                                echo "<td><button class='pd-setting' name='block' value=".$row['id'].">Block  </button></td>";
                        ...
                        if(array_key_exists('block',$_POST))	{
                            ...
                            $sql1="insert into `blockusers`(`id`, `name`, `email`, `phoneno`, `address`, `password`,profile) values ('$id','$name','$email','$phoneno','$address','$password','$profile')" ;
