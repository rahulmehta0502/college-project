		...
		<div class="container">
			...
			<div class="ads-grid">
				...
				<div class="agileinfo-ads-display col-md-9">
				   ...
				   include 'database.php';
				   $sql="select * from product where category='books' && sellid!='$userid' && status= '1'";
				   ...
				   <a href='http://localhost:8080/ip/zhatpat/categories/books.php?action=cartinsert& userid=".$userid." && pid=".$row['pid']."'> 
