		...
		<div class="container">
			...
			<div class="ads-grid">
				...
				<div class="w3-brand-select">
					<h3 class="agileits-sear-head">Furniture name</h3>
					  <select class="selectpicker" data-live-search="true">
						  <option data-tokens="All">All</option>
					  <option data-tokens="Table">Table</option>
					  <option data-tokens="Chair">Chair</option>
					  <option data-tokens="Sofa">Sofa</option>
					  <option data-tokens="Bed">Bed</option>
					  <option data-tokens="Dining Table">Dinning Table</option>
				...
				<div class="agileinfo-ads-display col-md-9">
					...
					<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						...
						include 'database.php';
						$sql="select * from product where category	='furnitures' && status= '1'";
						$result=mysqli_query($conn,$sql) or die( mysqli_error($conn));
						while($row=mysqli_fetch_array($result)) {
							$image="0_".$row['picture'];
						echo "<div class='clearfix'></div>
						<ul class='list'>
						<a href='http://localhost:8080/ip/zhatpat/categories/singleproduct.php?id=".$row['picture']." && sellid=".$row['sellid']." && pid=".$row['pid']."'> 
						<li>
						...
						<a href='http://localhost:8080/ip/zhatpat/categories/furnitures.php?action=cartinsert& userid=".$userid." && pid=".$row['pid']."'> 
