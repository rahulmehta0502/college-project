			...
			<div class="ads-grid">
				...
				<div class="agileinfo-ads-display col-md-9">
					...
					<?php
						...
						include 'database.php';
						$sql="select * from product where category	='bikes' && status= '1'";
						...
						<a href='http://localhost:8080/ip/zhatpat/categories/bikes.php?action=cartinsert& userid=".$userid." && pid=".$row['pid']."'> 
