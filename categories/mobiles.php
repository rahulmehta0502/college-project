			...
			<div class="ads-grid">
				...
				<div class="agileinfo-ads-display col-md-9">
					...
					<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						...
						include 'database.php';
						$sql="select * from product where category	='mobiles' && status= '1'";
						...
						<a href='http://localhost:8080/ip/zhatpat/categories/mobiles.php?action=cartinsert& userid=".$userid." && pid=".$row['pid']."'> 
