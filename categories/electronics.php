...
<html lang="en">
<head>
<title>Electronics-appliances Category</title>
			...
			<div class="ads-grid">
				...
				<div class="agileinfo-ads-display col-md-9">
					...
					<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						...
						<a href='http://localhost:8080/ip/zhatpat/categories/electronics.php?action=cartinsert& userid=".$userid." && pid=".$row['pid']."'> 
