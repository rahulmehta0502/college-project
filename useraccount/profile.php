        ...
        <div class='site-section' id='products-section'>
            <div class='container'>
                <div class='row mb-5 justify-content-center'>
                  ...
                  <form>
                  <p class='title'><label>User Name :  </label>".$row['name']."</p>
                  <p class='title'><label>Email :  </label>".$row['email']."</p>
                  <p class='title'><label>Contact :  </label>".$row['phoneno']."</p>
                  <p class='title'><label>Address :  </label>".$row['address']."</p>
                  <button class='pd-setting' name=update > <a href='http://localhost:8080/ip/zhatpat/useraccount/profile1.php?id=".$id."'>Edit  </a> </button>";
                  ?>
                  </form>
                  </div>
                    </div>
