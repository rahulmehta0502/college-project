...
<head>
    ...
    <title>User Payment Detail</title>
                ...
                <div class='row'>
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class='product-status-wrap'>
                            <br><h4>Payment Detail List</h4>
                            <?php
                            include 'database.php';
                            $sql="select * FROM `payment` where buyerid='$userid'";
                            ...
                            while($row=mysqli_fetch_array($result)){
                                ...
                                <tr>
								                    <td><img src='http://localhost:8080//ip/zhatpat/upload/0_".$row1['picture']."' style='width:15% height:15%' /></td>
                                    <td>".strtoupper($row1['category'])." </td>
									                  <td>".strtoupper($row1['name'])."</td> 
									                  <td>".strtoupper($row1['date'])."</td>
									                  <td>".strtoupper($row['total'])." </td>
									                  <td>".strtoupper($row['methodpay'])." </td>
									                  <td>----</td>
                                </tr>
