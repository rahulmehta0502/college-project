      ...
      <div class='container'>
        ...
        <div class='row'>
          <div class='col-lg-4 col-md-6 mb-5'>
            ...
            <h2><a href='http://localhost:8080/ip/zhatpat/categories/mobiles.php'>
              <figure>
          ...
          <div class='col-lg-4 col-md-6 mb-5'>
            <div class='product-item'>
            <h2><a href='http://localhost:8080/ip/zhatpat/categories/cars.php'>
              <figure>
          ...
          <div class='col-lg-4 col-md-6 mb-5'>
            <div class='product-item'>
            <h2><a href='http://localhost:8080/ip/zhatpat/categories/furnitures.php'>
              <figure>
          ...
          <div class='col-lg-4 col-md-6 mb-5'>
            <div class='product-item'><h2>
            <a href='http://localhost:8080/ip/zhatpat/categories/bikes.php'>
              <figure>
          ...
          <div class='col-lg-4 col-md-6 mb-5'>
            <div class='product-item'>
            <h2><a href='http://localhost:8080/ip/zhatpat/categories/electronics.php'>
              <figure>
          ...
          <div class='col-lg-4 col-md-6 mb-5'>
            <div class='product-item'>
            <h2><a href='http://localhost:8080/ip/zhatpat/categories/books.php'>
              <figure>
