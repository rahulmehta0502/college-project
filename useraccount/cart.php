      ...
      <div class='container'>
        <div class='row mb-5 justify-content-center'>
          <div class='col-md-6 text-center'>
            <h1 class='section-title mb-3'><u>Favourite List</u></h1>
        ...
        <div class='row'>
            ...
            <a href='http://localhost:8080/ip/zhatpat/categories/singleproduct.php?id=".$row['picture']." && sellid=".$row['sellid']." && pid=".$row['pid']."'>
              <figure>
                <tr><img src='http://localhost:8080//ip/zhatpat/upload/0_".$row['picture']."' height='120' width='120' alt='Image' class='img-fluid'></tr>
              </figure>
              
              <div class='px-4'>
                <tr><h3><b>".$row['name']."</b> </h3></tr>
                <tr><p class='mb-4'>Price:".$row['price']."</p></tr>
                <form method='post'>
                <div></a>
                  <tr><button class='pd-setting'  name=delete value=".$row['pid'].">Remove</button></tr>
                  
                  <button class='pd-setting' name=payment value=><a href='http://localhost:8080/ip/zhatpat/useraccount/totalpayment.php?pid=".$pid."&bidprice=".$row['price']."'> Payment  </button></a>
                </div>
          ...
          ";
            ...
            if(array_key_exists('delete',$_POST))	{
              $a=$_POST['delete'];
              $sql="delete FROM `cart` WHERE pid='$a' && userid='$userid'";
