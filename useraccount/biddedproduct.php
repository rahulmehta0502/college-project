...
<head>
    ...
    <title>Bidded Product List</title>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class='product-status-wrap'>
                            ...
                            <table>
                                ...
                                function h($pid,$bidprice,$remarks) {
                                ...
                                while($row1=mysqli_fetch_array($result1)) {
                                    ...
                                    if($remarks==1) {
                                      echo "<td>Bid Accepted</td>";
                                      echo "<td>
                                      <button class='pd-setting' name=payment value=><a href='http://localhost:8080/ip/zhatpat/useraccount/totalpayment.php?pid=".$pid."&bidprice=".$bidprice."'> Payment</a>  </button>
                                          </td>";
                                      }
                                      if($remarks==-1) {
                            ...
                            include 'database.php';
                            $sql="select * from buyer where b_id='$userid' ";
                            $result=mysqli_query($conn,$sql) or die( mysqli_error($conn));
                            while($row=mysqli_fetch_array($result)) {
                              $pid1=$row['p_id'];
                              $bidprice1=$row['bid_price'];
                              $remarks1=$row['remarks'];
                              h($pid1,$bidprice1,$remarks1);
                            }
