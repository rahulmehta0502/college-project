...
session_start();
$pid=$_GET['pid'];
$_SESSION['pprice']=$bidprice=$_GET['bidprice'];
$_SESSION['dc']=$dc=$bidprice*0.25;
$_SESSION['comm']=$comm=$bidprice*0.125;
$_SESSION['total']=$total=$bidprice+$dc+$comm;
?>
<!doctype html>
...
<body>
    ...
    <div class='all-content-wrapper'>
		...
		<div class='container'>
			<br><br><h2 class='w3-head'><font color='black'><center><b><u>Payment</u></b></center></font></h2>
      ...
      <?php
        ...
        $row=mysqli_fetch_array($result);
					echo "
        <form action='http://localhost:8080/ip/zhatpat/useraccount/userpayment.php?pid=".$pid."' method='post'>
        <div class='clearfix'></div>
					<label>Product Name : </label>
					<input type='text' class='phone' placeholder='".$row['name'] ."' readonly>
					<div class='clearfix'></div>
					<label>Product Price : </label>
					<input type='text' class='phone' name='pprice' value='$bidprice' readonly>
					<div class='clearfix'></div>
					<label> Delivery Charges : </label>
					<input type='text' class='phone' name='dc' value='$dc' readonly>
					<div class='clearfix'></div>
					<label> Commission : </label>
					<input type='text' class='phone' name='comm' value='$comm' readonly>
					<div class='clearfix'></div>
					<label> Total Amount : </label>
          <input type='text' class='phone'  name='total' value='$total' readonly>
          <input type='submit' value='Pay' style='float: right;' class='btn-success btn-lg'>
          </form>";			
            ?>			
