...
<body>
    ...
    <div class="all-content-wrapper">
		...
		<div class="container">
			<br><br><h2 class="w3-head"><font color="black"><center><b><u>Update Product</u></b></center></font></h2>
			<div class="post-ad-form">
				<form>
					...
					<input type="text" class="phone" placeholder="Product Name">
					<div class="clearfix"></div>
					<label>Product Price <span>*</span></label>
					<input type="text" class="phone" placeholder="Price">
					<div class="clearfix"></div>
